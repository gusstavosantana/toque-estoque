...
<html lang="en">
    <head>
        <title><?php echo $product[0]['nome_produto']; ?> | Toque&Estoque</title>
        <meta charset="UTF-8" />
            ...
            <div class="row">
                ...
                <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                    ...
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                        <h1 class="h2">Edição de produto:</h1>
                    </div>
                    <form class="form-product pb-4" method="POST" action="<?php echo base_url('dashboard/update-product'); ?>">
                        <div class="form-group">
                            <label for="inputProductName">Nome do produto</label>
                            <input type="hidden" name="id_produto" value="<?php echo $product[0]['id_produto']; ?>"/>
                            <input type="text" class="form-control" id="inputProductName" value="<?php echo $product[0]['nome_produto']; ?>" name="nome_produto" placeholder="Ex: Porta retrato" required/>
                        </div>
                        <div class="form-group">
                            <label for="inputProductDescription">Descrição do produto</label>
                            <textarea class="form-control" id="inputProductDescription" name="descricao_produto" rows="3" required><?php echo $product[0]['descricao_produto']; ?></textarea>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" id="inputProductPrice" value="<?php echo $product[0]['preco_produto']; ?>" name="preco_produto" placeholder="Ex: 129.99" min="0" step="any" required/>
                                </div>
                            </div>
                            <div class="form-group col-md-3">
                                <label for="inputProductQty">Quantidade em estoque</label>
                                <input type="number" class="form-control" id="inputProductQty" value="<?php echo $product[0]['qtd_produto']; ?>" name="qtd_produto" min="0" step="1" required/>
                            </div>
                        </div>
